...
public OnPlayerCommandText(playerid, cmdtext[]) {
        ...
        if (!strcmp("/laserboja", cmd, true)) {
                new tmp[256];
                tmp = strtok(cmdtext, idx);
                if (!strlen(tmp)) {
                        SendClientMessage(playerid, 0x00E800FF, "Koriscenje: /laserboja [boja]");
                        return 1;
                }
                if (!strcmp(tmp, "crvena", true)) SetPVarInt(playerid, "color", 18643);
                else if (!strcmp(tmp, "plava", true)) SetPVarInt(playerid, "color", 19080);
                else if (!strcmp(tmp, "roze", true)) SetPVarInt(playerid, "color", 19081);
                else if (!strcmp(tmp, "narandzasta", true)) SetPVarInt(playerid, "color", 19082);
                else if (!strcmp(tmp, "zelena", true)) SetPVarInt(playerid, "color", 19083);
                else if (!strcmp(tmp, "zuta", true)) SetPVarInt(playerid, "color", 19084);
                else SendClientMessage(playerid, 0x00E800FF, "Boja nedostupna!");
                return 1;
        }
